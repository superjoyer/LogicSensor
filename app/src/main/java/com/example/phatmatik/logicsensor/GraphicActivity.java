...
/**
 * Created by Phatmatik on 11.04.2015.
 */
public class GraphicActivity extends Applic {
   ...
   // private GraphViewSeries exampleSeries1;
    ...
    public static TextView textViewTemp;
   // public static TextView textViewHumi;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.graphic_activity_t);
        ...
        textViewTemp = (TextView)findViewById(R.id.textTemp);
       // textViewHumi = (TextView)findViewById(R.id.textViewHumi);
        ...
        exampleSeries2 = new GraphViewSeries("Sensor A", new GraphViewSeries.GraphViewSeriesStyle(Color.GREEN, 3),new GraphViewData[] {
        ...
        graphView.setCustomLabelFormatter(new CustomLabelFormatter() {
            @Override
            public String formatLabel(double temp, boolean isValueX) {
    ...
    protected void onResume() {
        ...
        mTimer2 = new Runnable() {
            @Override
            public void run() {
               // graph2LastXValue=getTime();
                graph2LastXValue += 1d;
                exampleSeries2.appendData(new GraphViewData(graph2LastXValue, temp), true, 10);
